...
test('MESH_WORKLOAD_TYPES covers §13B + §7f federated + Phase 10 labeling + Phase 13.5.1 citizen data sale + Phase 13.7 compute serving', () => {
  // Phase 3.0 (ADR 0071) added 'federated_round'.
  // Phase 10.1 (ADR 0121) added 'labeling'.
  // Phase 13.5.1 (ADR 0162) added 'citizen_data_sale'.
  // Phase 13.7 (ADR 0164) added 'compute_serving' — workers
  // earn from serving Phi-3-mini inferences to OTHER citizens
  // for fiat-credit.
  assert.deepEqual(
